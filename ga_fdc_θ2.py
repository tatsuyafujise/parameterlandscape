...
def main():
    ...
    dist = [np.linalg.norm([(data_sorted[i][0] - data_best_θ1 - 2) / 998, data_sorted[i][1] - data_best_θ2], ord=2) for i in range(10)]
    ...
    # # print(f"FDC: {fdc}")
    evaluations = [data_sorted[i][2] for i in range(10)]
